...
export const staticPrimaryColor = '#B07124'
export const staticPrimaryDarkenColor = '#9A5F1C'
...
export const themes: Record<string, ThemeDefinition> = {
  light: {
    ...
    colors: {
      ...
      'on-primary': '#fff',
      'primary-darken-1': '#9A5F1C',
      'secondary': '#8D7053',
      'on-secondary': '#fff',
      'secondary-darken-1': '#7A5F44',
      'success': '#28C76F',
      'on-success': '#fff',
      'success-darken-1': '#24B364',
      'info': '#D4AC71',
      'on-info': '#fff',
      'info-darken-1': '#C19B5F',
      'warning': '#FF9F43',
      'on-warning': '#fff',
