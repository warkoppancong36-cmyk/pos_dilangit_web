      ...
      <VCol cols="12" md="3">
        <VCard>
          <VCardText class="text-center pa-6">
            ...
            <div class="text-h4 font-weight-bold">{{ assets.length }}</div>
      ...
      <VCol cols="12" md="3">
        <VCard>
          <VCardText class="text-center pa-6">
            ...
            <div class="text-h4 font-weight-bold">{{ activeAssets.length }}</div>
      ...
      <VCol cols="12" md="3">
        <VCard>
          <VCardText class="text-center pa-6">
            ...
            <div class="text-h4 font-weight-bold">{{ maintenanceAssets.length }}</div>
            <div class="text-subtitle-2 text-medium-emphasis">Maintenance</div>
          </VCardText>
        </VCard>
      </VCol>
